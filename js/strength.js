...
var STRENGTH=(function(){
  ...
  var EXERCISE_MUSCLES={
    ...
    // Your requests
    'Zercher Squat':['quads','glutes','abs','biceps','lower-back'],
    'Wide Grip Shrug':['traps','side-delts'],
    'Tibia Resistance Band':['calves'],
    // Squat variations
    'Pause Squat':['quads','glutes'],
    'Box Squat':['quads','glutes','hamstrings'],
    'Safety Bar Squat':['quads','glutes'],
    'Pin Squat':['quads','glutes'],
    'Overhead Squat':['quads','glutes','front-delts','abs'],
    'Sissy Squat':['quads'],
    'Cossack Squat':['quads','glutes','hamstrings'],
    // Deadlift variations
    'Trap Bar Deadlift':['quads','glutes','hamstrings','traps'],
    'Deficit Deadlift':['hamstrings','glutes','lower-back'],
    'Rack Pull':['traps','lats','lower-back'],
    'Stiff Leg Deadlift':['hamstrings','lower-back','glutes'],
    'Single Leg RDL':['hamstrings','glutes'],
    'Block Pull':['traps','lats','lower-back'],
    'Snatch Grip Deadlift':['traps','lats','hamstrings'],
    // Bench variations
    'Paused Bench Press':['chest','triceps','front-delts'],
    'Spoto Press':['chest','triceps'],
    'Board Press':['triceps','chest'],
    'Floor Press':['triceps','chest'],
    'Larsen Press':['chest','triceps','abs'],
    'JM Press':['triceps'],
    'DB Bench Press':['chest','front-delts','triceps'],
    'Incline DB Press':['chest','front-delts'],
    // Row / pull variations
    'Chest Supported Row':['mid-back','lats','rear-delts'],
    'Meadows Row':['lats','mid-back','biceps'],
    'Yates Row':['lats','mid-back'],
    'Seal Row':['mid-back','lats','rear-delts'],
    'Kroc Row':['lats','mid-back','biceps'],
    'Single Arm Cable Row':['lats','mid-back','biceps'],
    'Wide Grip Pull Up':['lats','mid-back'],
    'Neutral Grip Pull Up':['lats','biceps'],
    'Weighted Pull Up':['lats','biceps','mid-back'],
    'Ring Row':['lats','mid-back','rear-delts'],
    // Shoulder variations
    'Seated DB Press':['front-delts','side-delts','triceps'],
    'Arnold Press':['front-delts','side-delts','triceps'],
    'Z Press':['front-delts','abs','side-delts'],
    'Cable Face Pull':['rear-delts','traps'],
    'Band Pull Apart':['rear-delts','traps'],
    'Reverse Pec Deck':['rear-delts'],
    'Handstand Push Up':['front-delts','triceps','traps'],
    // Arm variations
    ...
    'Dragon Flag':['abs'],
    'L-Sit':['abs'],
    'Landmine Twist':['obliques','abs'],
    'Suitcase Carry':['obliques','traps','forearms'],
    'Yoke Carry':['traps','quads','abs'],
    // Glute / hamstring
    ...
    // Athletic
    'Power Clean':['quads','glutes','traps','front-delts'],
    'Hang Clean':['quads','traps','front-delts'],
    'Push Press':['front-delts','triceps','quads'],
    'Kettlebell Swing':['glutes','hamstrings','lower-back'],
    'Kettlebell Clean':['quads','glutes','traps'],
    'Turkish Get Up':['abs','front-delts','glutes'],
    'Box Jump':['quads','calves','glutes'],
    'Sled Push':['quads','glutes','calves'],
    'Battle Ropes':['front-delts','triceps','abs'],
    // Machine / cable
    'Pec Deck':['chest'],
    ...
    'Adductor Machine':['quads'],
    'Abductor Machine':['quads'],
  };
